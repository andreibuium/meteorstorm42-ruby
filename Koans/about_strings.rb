...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #
    # BECAUSE: 
    # += creates a new object with a different value
    # << just modifies the value of hi
    # and since hi points to the same object as original_string,
    # original_string gets changed too
  end
