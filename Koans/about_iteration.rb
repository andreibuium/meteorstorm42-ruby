...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject / reduce  accumulates a result across the array
    # the argument is the initial value (which is assigned to the accumulator variable: sum)
    # the block defines the operation to apply
